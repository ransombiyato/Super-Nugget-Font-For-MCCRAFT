...
public class RenderSpellCircle extends EntityRenderer<EntitySpellCircle> {
	...
	static {
		for(int i = 0; i < LAYERS.length; i++) {
			Identifier texture = Identifier.parse(String.format(LibResources.MISC_SPELL_CIRCLE, i));
	...
	@Override
	public @NotNull Identifier getTextureLocation(@NotNull EntitySpellCircle entitySpellCircle) {
