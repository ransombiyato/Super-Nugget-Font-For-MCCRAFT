...
public class KeybindHandler {
	public static final KeyMapping keybind = new KeyMapping("psimisc.keybind", InputConstants.Type.KEYSYM, GLFW_KEY_C, KeyMapping.Category.register(Psi.location("psi")));
