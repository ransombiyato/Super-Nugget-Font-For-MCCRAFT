...
public abstract class PieceSelectorNearby extends PieceSelector {
	...
	public Object execute(SpellContext context) throws SpellRuntimeException {
		...
		List<Entity> list = context.caster.level().getEntitiesOfClass(Entity.class, area, (Entity e) -> e != null && pred.test(e) && e != context.caster && e != context.focalPoint && context.isInRadius(e));
