...
public class PieceTrickExplode extends PieceTrick {
	...
	public Object execute(SpellContext context) throws SpellRuntimeException {
		...
		context.focalPoint.level().explode(context.focalPoint, positionVal.x, positionVal.y, positionVal.z, (float) powerVal, isLiquid(state) ? Level.ExplosionInteraction.NONE : Level.ExplosionInteraction.TNT);
		return null;
	}
