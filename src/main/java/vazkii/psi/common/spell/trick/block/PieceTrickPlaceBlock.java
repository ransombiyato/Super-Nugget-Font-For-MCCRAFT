...
public class PieceTrickPlaceBlock extends PieceTrick {
	...
	public Object execute(SpellContext context) throws SpellRuntimeException {
		...
		if(directionVal != null) {
			facing = Direction.getNearest((int) Math.signum(directionVal.x), (int) Math.signum(directionVal.y), (int) Math.signum(directionVal.z), Direction.NORTH);
		...
		placeBlock(context.caster, context.focalPoint.level(), pos, context.getTargetSlot(), false, facing, horizontalFacing);
