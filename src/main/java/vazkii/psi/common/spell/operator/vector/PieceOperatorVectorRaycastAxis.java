...
public class PieceOperatorVectorRaycastAxis extends PieceOperator {
	...
	public Object execute(SpellContext context) throws SpellRuntimeException {
		...
		BlockHitResult pos = context.caster.level().clip(new ClipContext(originVal.toVec3D(), end.toVec3D(), ClipContext.Block.OUTLINE, ClipContext.Fluid.NONE, context.caster));
