...
public final class ModItems {
	...
	public static final DeferredHolder<Item, ItemPsimetalExosuitHelmet> psimetalExosuitHelmet = ITEMS.register(LibItemNames.PSIMETAL_EXOSUIT_HELMET, () -> new ItemPsimetalExosuitHelmet(ArmorType.HELMET, defaultBuilder().durability(ArmorType.HELMET.getDurability(18))));
	public static final DeferredHolder<Item, ItemPsimetalExosuitChestplate> psimetalExosuitChestplate = ITEMS.register(LibItemNames.PSIMETAL_EXOSUIT_CHESTPLATE, () -> new ItemPsimetalExosuitChestplate(ArmorType.CHESTPLATE, defaultBuilder().durability(ArmorType.CHESTPLATE.getDurability(18))));
	public static final DeferredHolder<Item, ItemPsimetalExosuitLeggings> psimetalExosuitLeggings = ITEMS.register(LibItemNames.PSIMETAL_EXOSUIT_LEGGINGS, () -> new ItemPsimetalExosuitLeggings(ArmorType.LEGGINGS, defaultBuilder().durability(ArmorType.LEGGINGS.getDurability(18))));
	public static final DeferredHolder<Item, ItemPsimetalExosuitBoots> psimetalExosuitBoots = ITEMS.register(LibItemNames.PSIMETAL_EXOSUIT_BOOTS, () -> new ItemPsimetalExosuitBoots(ArmorType.BOOTS, defaultBuilder().durability(ArmorType.BOOTS.getDurability(18))));
