...
public class ItemPsimetalPickaxe extends Item implements IPsimetalTool {

	public ItemPsimetalPickaxe(Item.Properties properties) {
		super(properties.pickaxe(PsiAPI.PSIMETAL_TOOL_MATERIAL, 1, -2.8F).component(ModDataComponents.BULLETS.get(), ItemContainerContents.EMPTY));
	}
