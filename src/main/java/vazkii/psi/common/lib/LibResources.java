...
public class LibResources {
	...
	public static final Identifier PATCHOULI_BOOK = Psi.location("encyclopaedia_psionica");
	...
	public static final Identifier MODEL_PSIMETAL_EXOSUIT = Psi.location(PREFIX_MODEL + "psimetal_exosuit.png");
	public static final Identifier MODEL_PSIMETAL_EXOSUIT_SENSOR = Psi.location(PREFIX_MODEL + "psimetal_exosuit_sensor.png");
