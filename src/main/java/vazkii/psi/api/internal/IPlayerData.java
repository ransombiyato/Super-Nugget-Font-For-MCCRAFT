...
public interface IPlayerData {
	 ...
	 */
	default boolean isPieceGroupUnlocked(Identifier group) {
	 ...
	 */
	boolean isPieceGroupUnlocked(Identifier group, @Nullable Identifier piece);

	/**
	 * Unlocks the given piece group.
	 */
	void unlockPieceGroup(Identifier group);
