...
public interface ITrickRecipe extends Recipe<SingleRecipeInput> {
	 ...
	 */
	Identifier TYPE_ID = PsiAPI.location("trick_crafting");
	...
	default RecipeType<? extends Recipe<SingleRecipeInput>> getType() {
		return (RecipeType<? extends Recipe<SingleRecipeInput>>) (RecipeType<?>) BuiltInRegistries.RECIPE_TYPE.getValue(TYPE_ID);
	}
