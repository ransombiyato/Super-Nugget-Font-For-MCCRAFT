...
public class PieceKnowledgeEvent extends PsiEvent implements PsiCancellableEvent {
	@NotNull
	private final Identifier pieceGroup;

	@Nullable
	private final Identifier pieceName;
	...
	public PieceKnowledgeEvent(@NotNull Identifier pieceGroup, @Nullable Identifier pieceName, @NotNull Player player, @NotNull IPlayerData data, boolean isUnlocked) {
	 ...
	 */
	@NotNull
	public Identifier getPieceGroup() {
		return pieceGroup;
	}
	 ...
	 */
	@Nullable
	public Identifier getPieceName() {
		return pieceName;
	}
